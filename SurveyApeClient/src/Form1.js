  ...
  render(){
    return(
          ...
          <form className="form-group">
            ...
            <div>
                <div style={{marginLeft:"20%"}}>
                      <div>
                    <h4>Survey Name:</h4>
                    <input type="text" className="borderBottom"  style={{width: "80%",height:30}} value={this.state.surveyName} onChange={(event)=>this.setState({surveyName:event.target.value})}/>
                      </div>
      ...
      <div style={{marginLeft:"20%"}}>
        <div>
          <h4>Survey Type:</h4>
              <select style={{width: "80%", height:30}} onChange={(event)=>{this.setState({formType:event.target.value})}}>
      ...
      <br/>
          ...
          <div style={{marginLeft:"20%"}}>
              <div>
                  <h4>End Time:</h4>
                <input type="date" style={{width: "50%"}} style={{width:"80%",height:30}} onChange={(event)=>this.setState({endTime:event.target.value})}/>
              </div>
          </div>
        ...
        <div style={{marginLeft:"45%"}}>
          ...
          <div >
              <input type="button" className="btn btn-primary" value="Save and Publish" style={{margin:"100px 200px 100px 500px"}} onClick={()=>{
                  this.createS({type:this.state.formType,questions:this.state.questions,name:this.state.surveyName,publish:true});
                  this.setState({
                    questions:[],
                    type:null,
                    choice:null,
