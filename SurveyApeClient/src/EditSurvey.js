        ...
        API.getSurvey(this.props.surveyId)
            .then((res) => {
                ...
                if (res.survey !== undefined) {
                    for (var i = 0; i < res.survey.questionList.length; i++) {
                        var type = res.survey.questionList[i].questionType;
                        var style = null;
                        var ans = null;
                        var choice = null;
                        if (type === 1) {
                        ...
                        var optionList = [];
                        for (var j = 0; j < res.survey.questionList[i].questionOptionList.length; j++) {
                            optionList.push(res.survey.questionList[i].questionOptionList[j].optionText);
                        }
                        var x = 0;
                        for (var j = 0; j < res.survey.responseList.length; j++) {
                            if (res.survey.responseList[j].completeInd === true) {
                                x++;
                            }
                        }
                        ...
                        temp.push({
                            id: id,
                            questionText: res.survey.questionList[i].questionText,
    ...
    render() {
        return (
            <div style={{marginLeft: "20%"}}>
                ...
                <h4>SurveyName:</h4>
                <input type="text" style={{width: "80%"}} value={this.state.surveyTitle}
                       onChange={(event) => this.setState({surveyTitle: event.target.value})}/><br/>
                <h4>Survey Start Date:</h4>
                <input type="date" style={{width: "80%"}} value={this.state.startDate}
                       onChange={(event) => this.setState({startDate: event.target.value})}/><br/>
                <h4>Survey End Date:</h4>
                <input type="date" style={{width: "80%"}} value={this.state.endDate}
                       onChange={(event) => this.setState({endDate: event.target.value})}/><br/>
                {this.state.surveyType === 1 ? (<div>
                    <h4>Invitee List:</h4>
                    <input type="text" style={{width: "80%"}} value={this.state.inviteeStr}
                           onChange={(event) => this.setState({inviteeStr: event.target.value})}/> <br/>
                </div>) : (<div>
                </div>)}
                {this.state.surveyType === 3 ? (<div>
                    <h4>Closed survey List:</h4>
                    <input type="text" style={{width: "80%"}} value={this.state.closedSurveyStr}
                           onChange={(event) => this.setState({closedSurveyStr: event.target.value})}/> <br/>
                </div>) : (<div>
                </div>)}
                <div>
                        ...
                        {this.state.type === "MCQ" ? (
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <input type="text" style={{width: "80%"}} value={this.state.options}
                                                       onChange={(event) => {
                            ...
                            <div>
                                ...
                                <div>
                                    <div>
                                        <h4>Question</h4>
                                        <input type="text" value={this.state.question} style={{width: "80%"}}
                                               onChange={(event) => {
                                                   this.setState({question: event.target.value});
                                               }}/>
                                    </div>
